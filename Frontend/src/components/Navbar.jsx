...
const Navbar = () => {
  ...
  useEffect(() => {
    // Apply the theme before the page renders to avoid a flash of white background
  ...
  return (
    <div
      className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 ${sticky
    ...
    >
      <div className="navbar dark:bg-slate-900 dark:text-white">
        <div className="navbar-start">
          ...
          <a className="btn font-bold cursor-pointer text-2xl">Book store</a>
        </div>
        <div className="navbar-end space-x-3">
          ...
          <label className="swap swap-rotate">
            ...
            >
              <path
                d="M21.64,13a1,1,0,0,0-1.05-.14,7.05,7.05,0,0,1-3.37.73A8.15,7.15,0,0,1,9.08,5.49a8.59,7.59,0,0,1,.25-2A1,1,0,0,0,7,2.36,7.14,7.14,0,1,0,21.64,13Z"
              />
            </svg>
          </label>
